  ...
  return (
   <footer className="border-t py-12">
        ...
        <div className="md:mx-auto" data-aos="fade-left">
            ...
            <div>
                ...
                <p>
                    ...
                    <a href="tel:+919322663609" target="_blank" className="hover:text-gray-700">+91 93226 63609</a>
                </p>
            </div>
            <div className="mt-4">
                ...
                <p>
                    ...
                    <a href="mailto:shubhamdhapola153@gmail.com" target="_blank" className="hover:text-gray-700">shubhamdhapola143@gmail.com</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-600 text-sm tracking-tighter text-center">&copy; 2025, Rabbit. All Rights Reserved.</p>
    </div>
